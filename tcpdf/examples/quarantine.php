...
$pdf->SetTitle('List Of Quarantined Items');
$pdf->SetSubject('List Of Quarantined Items');
...
$html .= '
	...
	<table cellpadding="5" width="100%" style="border-spacing: 0;">
		<tr align="center" style="font-size:10px;background-color: #f2f2f2" color="#a9a9a9">
			<th width="35%" align="left" style="border: 1px solid #e2e2e2">&nbsp;&nbsp;<b>PRODUCT</b></th>
			<th width="10%" style="border: 1px solid #e2e2e2"><b>UOM</b></th>
			<th width="15%" style="border: 1px solid #e2e2e2"><b>LOT NO</b></th>
			<th width="15%" style="border: 1px solid #e2e2e2"><b>ORDER DATE</b></th>
...
if($_GET['action'] == "qqq"){
	...
	$meta = '
		<table align="right" width="100%" style="border-spacing: 0 5px">
			<tr>
				<td style="width:100%"><h4><b>Quarantined Items</b></h4></td>
			</tr>
			<tr>
				<td>'.date('F d, Y ').'</td>
			</tr>
